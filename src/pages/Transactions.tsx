...
const Transactions: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Process the transaction text without modifying the amount
    // The sign will be determined by the transaction context
    const processedText = transactionText;
    
    // Pass the transaction type to indicate if this is a credit or debit
    addTransaction(processedText, selectedDate, transactionType);
      ...
      <div className="container max-w-md mx-auto pt-20 px-4">
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            {/* Filter button moved to transaction list header below */}
          </div>
